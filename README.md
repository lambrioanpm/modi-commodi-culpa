# @lambrioanpm/modi-commodi-culpa

> forked from [@lambrioanpm/modi-commodi-culpaode](https://www.npmjs.com/package/@lambrioanpm/modi-commodi-culpaode) v11.1.0. as the original repository seems [no longer maintained](https://github.com/mysticatea/@lambrioanpm/modi-commodi-culpaode/issues/300).

[![npm version](https://img.shields.io/npm/v/@lambrioanpm/modi-commodi-culpa.svg)](https://www.npmjs.com/package/@lambrioanpm/modi-commodi-culpa)
[![Downloads](https://img.shields.io/npm/dm/@lambrioanpm/modi-commodi-culpa.svg)](https://www.npmjs.com/package/@lambrioanpm/modi-commodi-culpa)
[![Build Status](https://github.com/lambrioanpm/modi-commodi-culpa/workflows/CI/badge.svg)](https://github.com/lambrioanpm/modi-commodi-culpa/actions)
...
```sh
npm install --save-dev eslint @lambrioanpm/modi-commodi-culpa
```
...
```js
const nodePlugin = require("@lambrioanpm/modi-commodi-culpa")
...
💼 [Configurations](https://github.com/lambrioanpm/modi-commodi-culpa#-configs) enabled in.\
☑️ Set in the `flat/recommended` [configuration](https://github.com/lambrioanpm/modi-commodi-culpa#-configs).\
🟢 Set in the `flat/recommended-module` [configuration](https://github.com/lambrioanpm/modi-commodi-culpa#-configs).\
✅ Set in the `flat/recommended-script` [configuration](https://github.com/lambrioanpm/modi-commodi-culpa#-configs).\
☑️ Set in the `recommended` [configuration](https://github.com/lambrioanpm/modi-commodi-culpa#-configs).\
🟢 Set in the `recommended-module` [configuration](https://github.com/lambrioanpm/modi-commodi-culpa#-configs).\
✅ Set in the `recommended-script` [configuration](https://github.com/lambrioanpm/modi-commodi-culpa#-configs).\
...
`@lambrioanpm/modi-commodi-culpa` follows [semantic versioning](http://semver.org/) and [ESLint's Semantic Versioning Policy](https://github.com/eslint/eslint#semantic-versioning-policy).
...
- [GitHub Releases](https://github.com/lambrioanpm/modi-commodi-culpa/releases)
